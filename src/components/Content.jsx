export function Content(){
  ...
  <div class="grid items-center grid-cols-1 mb-24 md:grid-cols-2 gap-y-10 md:gap-y-32 gap-x-10 md:gap-x-24">
    <div>
      <h2 class="mb-4 text-2xl font-extrabold tracking-tight text-center text-black-700 md:leading-tight sm:text-left md:text-4xl">Prestamo de equipo para<h2 className="text-teal-500">los estudiantes de la utch</h2></h2>
  ...
  <div class="grid items-center grid-cols-1 mb-24 md:grid-cols-2 gap-y-10 md:gap-y-32 gap-x-10 md:gap-x-24">
    ...
    <h2 class="mb-4 text-2xl font-extrabold tracking-tight text-center text-black-700 md:leading-tight sm:text-left md:text-4xl">Como funcionara el <h2 className="text-teal-500">prestamo del material?</h2></h2>
      <p class="mb-5 text-base text-center text-gray-600 sm:text-left md:text-lg">
