...
export default function Showusers() {
  ...
  const deleteUsersConfirm = (user) => {
    Swal.fire({
      title: "Are you sure?",
      text: "You will delete the user " + user.nombre,
      icon: "warning",
      ...
      if (result.isConfirmed) {
        Swal.fire({
          title: "Deleted",
          text: "The user " + user.nombre + " has been deleted",
          icon: "success",
        });
